...
export function Hero() {
  return (
    <section className="flex items-center justify-center mt-30 bg-green-50">
      <div className="container px-4  
        sm:px-6">

        <main className="flex items-center space-between w-auto 
        justify-center sm:flex-col lg:flex-row">
