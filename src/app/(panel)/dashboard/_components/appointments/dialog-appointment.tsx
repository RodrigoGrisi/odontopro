      ...
      <div className="py-4">
        ...
        {appointment && (
          <article>
            ...
            <p className="mb-2"><span className="font-semibold">Data do agendamento:</span> {format(appointment.appointmentData, "dd/MM/yyyy")}</p>
            ...
            <section className="bg-gray-100 mt-4 p-2 rounded-md">
              ...
              <p><span className="font-semibold">Valor:</span> R$ {((appointment.service.price / 100))}</p>
            </section>
